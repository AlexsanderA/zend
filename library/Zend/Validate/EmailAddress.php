...
class Zend_Validate_EmailAddress extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID            => " Неверный тип даных. Строка ожидается",
        self::INVALID_FORMAT     => "'%value%' не верный адрес электронной почты. Введите в формате name@mails.ru",
        self::INVALID_HOSTNAME   => "'%hostname%' не является допустимым именем узла адреса электронной почты '%value%'",
